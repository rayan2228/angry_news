                        ...
                        <div class="col-lg-12">
                            <div class="slider-activation axil-slick-arrow">
                                ...
                                <div class="content-block">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/gallery-post-01.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <!-- End Post Thumbnail  -->
                                        ...
                                        <div class="post-meta-wrapper with-button">
                                            <div class="post-meta">
                                                <div class="post-author-avatar border-rounded">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-images/author/author-image-3.png"
                                                        alt="Author Images">
                                                </div>
                                                <div class="content">
                                ...
                                <div class="content-block">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/gallery-post-03.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <!-- End Post Thumbnail  -->
                                    <!-- Start Post Content  -->
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta-wrapper with-button">
                                            <div class="post-meta">
                                                <div class="post-author-avatar border-rounded">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-images/author/author-image-1.png"
                                                        alt="Author Images">
                                                </div>
                                                <div class="content">
                                                    <h6 class="post-author-name">
                                ...
                                <div class="content-block">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/gallery-post-02.jpg" alt="Post Images">
                                        </a>
                                    </div>
                                    <!-- End Post Thumbnail  -->
                                    <!-- Start Post Content  -->
                                    <div class="post-content">
                                        ...
                                        <div class="post-meta-wrapper with-button">
                                            <div class="post-meta">
                                                <div class="post-author-avatar border-rounded">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-images/author/author-image-2.png"
                                                        alt="Author Images">
                                                </div>
                                                <div class="content">
                                                    <h6 class="post-author-name">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-12 mt--30">
                        <div
                            ...
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('frontend') }}/assets/images/post-images/post-images-1.jpg" alt="Post Images">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-12 mt--30">
                        <div
                            class="content-block content-direction-column axil-control post-horizontal  thumb-border-rounded">
                            <div class="post-content">
                                <div class="post-cat">
                                    <div class="post-cat-list">
                                        <a class="hover-flip-item-wrapper" href="#">
                            ...
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('frontend') }}/assets/images/post-images/post-images-2.jpg" alt="Post Images">
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="axil-banner mb--30">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="w-100" src="{{ asset('frontend') }}/assets/images/add-banner/banner-03.png"
                                            alt="Banner Images">
                                    </a>
                                </div>
                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="slick-single-layout">
                                            <div
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/post-column-04.jpg"
                                                            alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/post-column-05.jpg"
                                                            alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <h4 class="title"><a href="post-details.html">Creative Game With The
                                                            New
                                                            DJI Mavic Air 2</a></h4>
                                                </div>
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/post-column-06.jpg"
                                                            alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/post-column-07.jpg"
                                                            alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="slick-single-layout">
                                            <div
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/post-column-08.jpg"
                                                            alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/post-column-01.jpg"
                                                            alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="slick-single-layout">
                                            <div
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/post-column-02.jpg"
                                                            alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div
                                        ...
                                        <div class="slick-single-layout">
                                            <div
                                                ...
                                                <div class="post-thumbnail">
                                                    <a href="post-details.html">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/post-column-03.jpg"
                                                            alt="Post Images">
                                                    </a>
                                                </div>
                                            </div>
                        ...
                        <div class="list-categories d-flex flex-wrap">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-sm-01.jpg"
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-sm-02.jpg"
                                                alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-sm-03.jpg"
                                                alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-sm-04.jpg"
                                                alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-sm-05.jpg"
                                                alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="single-cat">
                                <div class="inner">
                                    <a href="#">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-sm-06.jpg"
                                                alt="post categories images">
                                        </div>
                                        <div class="content">
                            ...
                            <div class="row trend-tab-content tab-pane fade show active" id="trendone" role="tabpanel"
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <div class="content-block trend-post post-order-list axil-control">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/post-images/trend-post-01.jpg"
                                                    alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content-block trend-post post-order-list is-active">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/post-images/trend-post-02.jpg"
                                                    alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content-block trend-post post-order-list axil-control">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/post-images/trend-post-03.jpg"
                                                    alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="content-block trend-post post-order-list axil-control">
                                        <div class="post-inner">
                                            ...
                                            <div class="post-content">
                                                ...
                                                <h3 class="title"><a href="post-details.html">6 ways you can make your
                                                        design more inclusive and equitable</a></h3>
                                                <div class="post-meta-wrapper">
                                                    <div class="post-meta">
                                                        <div class="content">
                                                            <h6 class="post-author-name">
                                        ...
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/post-images/trend-post-04.jpg"
                                                    alt="Post Images">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-7 col-lg-7 col-md-12 col-12">
                                        ...
                                        <div class="content-block post-grid post-grid-large mt--30">
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-images/post-grid-01.jpg"
                                                        alt="Post Images">
                                                </a>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                                ...
                                                <div class="content-block post-grid mt--30">
                                                    <div class="post-thumbnail">
                                                        <a href="post-details.html">
                                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-grid-07.jpg"
                                                                alt="Post Images">
                                                        </a>
                                                    </div>
                                                    <div class="post-grid-content">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                                ...
                                                <div class="content-block post-grid mt--30">
                                                    <div class="post-thumbnail">
                                                        <a href="post-details.html">
                                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-grid-08.jpg"
                                                                alt="Post Images">
                                                        </a>
                                                    </div>
                                                    <div class="post-grid-content">
                                ...
                                <div class="row">
                                    <div class="col-xl-7 col-lg-7 col-md-12 col-12">
                                        ...
                                        <div class="content-block post-grid post-grid-large mt--30">
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-images/post-grid-09.jpg"
                                                        alt="Post Images">
                                                </a>
                                            </div>
                                            <div class="post-grid-content">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                                ...
                                                <div class="content-block post-grid mt--30">
                                                    <div class="post-thumbnail">
                                                        <a href="post-details.html">
                                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-grid-02.jpg"
                                                                alt="Post Images">
                                                        </a>
                                                    </div>
                                                    <div class="post-grid-content">
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-6 col-12">
                                                ...
                                                <div class="content-block post-grid mt--30">
                                                    <div class="post-thumbnail">
                                                        <a href="post-details.html">
                                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-grid-03.jpg"
                                                                alt="Post Images">
                                                        </a>
                                                    </div>
                                                    <div class="post-grid-content">
                            ...
                            <div class="axil-single-widget widget widget_categories mb--30">
                                <ul>
                                    <li class="cat-item">
                                        <a href="#" class="inner">
                                            <div class="thumbnail">
                                                <img src="{{ asset('frontend') }}/assets/images/post-images/category-image-01.jpg" alt="">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="cat-item">
                                        <a href="#" class="inner">
                                            <div class="thumbnail">
                                                <img src="{{ asset('frontend') }}/assets/images/post-images/category-image-02.jpg" alt="">
                                            </div>
                                            <div class="content">
                                    ...
                                    <li class="cat-item">
                                        <a href="#" class="inner">
                                            <div class="thumbnail">
                                                <img src="{{ asset('frontend') }}/assets/images/post-images/category-image-03.jpg" alt="">
                                            </div>
                                            <div class="content">
                                                <h5 class="title">Travel</h5>
                                            </div>
                                    ...
                                    <li class="cat-item">
                                        <a href="#" class="inner">
                                            <div class="thumbnail">
                                                <img src="{{ asset('frontend') }}/assets/images/post-images/category-image-04.jpg" alt="">
                                            </div>
                                            <div class="content">
                            ...
                            <div class="axil-single-widget widget widget_postlist mb--30">
                                ...
                                <div class="post-medium-block">
                                    ...
                                    <div class="content-block post-medium mb--20">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/small-images/blog-sm-01.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="content-block post-medium mb--20">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/small-images/blog-sm-02.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                    ...
                                    <div class="content-block post-medium mb--20">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/small-images/blog-sm-03.jpg" alt="Post Images">
                                            </a>
                                        </div>
                                        <div class="post-content">
                                            <h6 class="title"><a href="post-details.html">How a developer and designer
                            ...
                            <div class="axil-single-widget widget widget_instagram mb--30">
                                ...
                                <ul class="instagram-post-list-wrapper">
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-01.jpg"
                                                alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-02.jpg"
                                                alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-03.jpg"
                                                alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-04.jpg"
                                                alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-05.jpg"
                                                alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-06.jpg"
                                                alt="Instagram Images">
                                        </a>
                                    </li>
                                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-md-6 col-12">
                        ...
                        <div class="content-block post-default image-rounded mt--30">
                            <div class="post-thumbnail">
                                <a href="post-details.html">
                                    <img src="{{ asset('frontend') }}/assets/images/post-images/post-dark-01.jpg" alt="Post Images">
                                </a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="content-block post-default image-rounded mt--30">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-dark-04.jpg" alt="Post Images">
                                        </a>
                                    ...
                                    <div class="post-content">
                                        ...
                                        <h5 class="title"><a href="post-details.html">Get Ready To Up Your Creative Game
                                                With The </a></h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="content-block post-default  image-rounded mt--30">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-dark-03.jpg" alt="Post Images">
                                        </a>
                                        <a class="video-popup size-medium position-top-center"
                                            href="post-details.html"><span class="play-icon"></span></a>
                                    </div>
                                    <div class="post-content">
                                        ...
                                        <h5 class="title"><a href="post-details.html">Traditional design won’t save us
                                                in the COVID-19 era</a></h5>
                                    </div>
                                </div>
                            </div>
                            <!-- End Post List  -->
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="content-block post-default image-rounded mt--30">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <h5 class="title"><a href="post-details.html">New: Freehand Templates, built for
                                                the whole team</a></h5>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="content-block post-default image-rounded mt--30">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/post-dark-05.jpg" alt="Post Images">
                                        </a>
                                        <a class="video-popup size-medium position-top-center"
                                            href="post-details.html"><span class="play-icon"></span></a>
                                    </div>
