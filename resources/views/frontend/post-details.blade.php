                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="content-block">
                            ...
                            <div class="post-thumbnail">
                                <img src="{{ asset('frontend') }}/assets/images/post-single/post-single-01.jpg" alt="Post Images">
                            </div>
                            <!-- End Post Thumbnail  -->
                            <!-- Start Post Content  -->
                                ...
                                <div class="post-meta-wrapper">
                                    <div class="post-meta">
                                        <div class="post-author-avatar border-rounded">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/author/author-image-3.png" alt="Author Images">
                                        </div>
                                        <div class="content">
                    ...
                    <div class="col-lg-8">
                        <div class="axil-post-details">
                            ...
                            <figure class="wp-block-image">
                                <img src="{{ asset('frontend') }}/assets/images/post-single/post-single-02.jpg" alt="Post Images">
                            ...
                            <figure class="wp-block-image">
                                <img src="{{ asset('frontend') }}/assets/images/post-single/post-single-03.jpg" alt="Post Images">
                                <figcaption>The Apple Design Award trophy, created by the Apple Design team, is a symbol
                                    of achievement and excellence.</figcaption>
                            </figure>
                            <h2>Apple Design Award Winners: Apps</h2>
                            ...
                            <figure class="wp-block-image">
                                <img src="{{ asset('frontend') }}/assets/images/post-single/post-single-04.jpg" alt="Post Images">
                                <figcaption>The Apple Design Award trophy, created by the Apple Design team, is a symbol
                                    of achievement and excellence.</figcaption>
                            </figure>
                                            ...
                                            <div class="comment-body">
                                                <div class="single-comment">
                                                    <div class="comment-img">
                                                        <img src="{{ asset('frontend') }}/assets/images/post-images/author/author-b2.png" alt="Author Images">
                                                    </div>
                                            ...
                                            <ul class="children">
                                                ...
                                                <li class="comment">
                                                    <div class="comment-body">
                                                        <div class="single-comment">
                                                            <div class="comment-img">
                                                                <img src="{{ asset('frontend') }}/assets/images/post-images/author/author-b3.png" alt="Author Images">
                                                            </div>
                                                            <div class="comment-inner">
                                                                <h6 class="commenter">
                                                                    <a class="hover-flip-item-wrapper" href="#">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="sidebar-inner">
                            ...
                            <div class="axil-single-widget widget widget_ads mb--30">
                                ...
                                <div class="thumbnail">
                                    <a href="#">
                                        <img src="{{ asset('frontend') }}/assets/images/post-single/ads-01.jpg" alt="Ads Images">
                                    </a>
                                </div>
                                <!-- End Post List  -->
                            </div>
                            ...
                            <div class="axil-single-widget widget widget_instagram mb--30">
                                ...
                                <ul class="instagram-post-list-wrapper">
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-01.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-02.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-03.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-04.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-05.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                    <li class="instagram-post-list">
                                        <a href="#">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/instagram-06.jpg" alt="Instagram Images">
                                        </a>
                                    </li>
                                </ul>
                                <!-- End Post List  -->
                                ...
                                <div class="video-post-wrapepr">
                                    ...
                                    <div class="content-block image-rounded">
                                        <div class="post-content">
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-single/post-md-01.jpg" alt="Post Images">
                                                </a>
                                    ...
                                    <div class="content-block image-rounded mt--20">
                                        <div class="post-content">
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-single/post-md-02.jpg" alt="Post Images">
                                                </a>
                                                <a class="video-popup size-medium icon-color-secondary position-top-center" href="post-details.html"><span class="play-icon"></span></a>
                                            </div>
                                    ...
                                    <div class="content-block image-rounded mt--20">
                                        <div class="post-content">
                                            <div class="post-thumbnail">
                                                <a href="post-details.html">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-single/post-md-03.jpg" alt="Post Images">
                                                </a>
                                                <a class="video-popup size-medium icon-color-secondary position-top-center" href="post-details.html"><span class="play-icon"></span></a>
                                            </div>
                            ...
                            <div class="axil-banner">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="w-100" src="{{ asset('frontend') }}/assets/images/add-banner/banner-02.png" alt="Banner Images">
                                    </a>
                                </div>
                            </div>
