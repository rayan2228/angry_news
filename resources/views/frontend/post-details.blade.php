                ...
                <div class="col-lg-8">
                    <div class="axil-post-details">
                        ...
                        <figure class="wp-block-image">
                            <img src="{{ asset('frontend') }}/assets/images/post-single/post-single-02.jpg"
                                alt="Post Images">
                        ...
                        <figure class="wp-block-image">
                            <img src="{{ asset('frontend') }}/assets/images/post-single/post-single-03.jpg"
                                alt="Post Images">
                            <figcaption>The Apple Design Award trophy, created by the Apple Design team, is a symbol
                                of achievement and excellence.</figcaption>
                        </figure>
                        ...
                        <figure class="wp-block-image">
                            <img src="{{ asset('frontend') }}/assets/images/post-single/post-single-04.jpg"
                                alt="Post Images">
                            <figcaption>The Apple Design Award trophy, created by the Apple Design team, is a symbol
                                of achievement and excellence.</figcaption>
                        </figure>
                            ...
                            <div class="comment-respond">
                                ...
                                <form
                                    action="@if (auth()->check() ||
                                        auth()->guard('admin')->check()) {{ route('comment.store') }}
                                        @else
                                        {{ route('login') }} @endif"
                                    method="POST">
                                    @csrf
                                    <div class="row row--10">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-submit cerchio">
                                                <button id="submit" class="axil-button button-rounded">Post
                                                    Comment</button>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="comment-body">
                                            <div class="single-comment">
                                                <div class="comment-img">
                                                    <img src="{{ asset('frontend') }}/assets/images/post-images/author/author-b2.png"
                                                        alt="Author Images">
                                                </div>
                                        ...
                                        <ul class="children">
                                            ...
                                            <li class="comment">
                                                <div class="comment-body">
                                                    <div class="single-comment">
                                                        <div class="comment-img">
                                                            <img src="{{ asset('frontend') }}/assets/images/post-images/author/author-b3.png"
                                                                alt="Author Images">
                                                        </div>
                                                        <div class="comment-inner">
                                                            <h6 class="commenter">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="sidebar-inner">
                        ...
                        <div class="axil-single-widget widget widget_categories mb--30">
                            <ul>
                                <li class="cat-item">
                                    <a href="#" class="inner">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/category-image-01.jpg"
                                                alt="">
                                        </div>
                                        <div class="content">
                                ...
                                <li class="cat-item">
                                    <a href="#" class="inner">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/category-image-02.jpg"
                                                alt="">
                                        </div>
                                        <div class="content">
                                ...
                                <li class="cat-item">
                                    <a href="#" class="inner">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/category-image-03.jpg"
                                                alt="">
                                        </div>
                                        <div class="content">
                                ...
                                <li class="cat-item">
                                    <a href="#" class="inner">
                                        <div class="thumbnail">
                                            <img src="{{ asset('frontend') }}/assets/images/post-images/category-image-04.jpg"
                                                alt="">
                                        </div>
                                        <div class="content">
                        ...
                        <div class="axil-single-widget widget widget_postlist mb--30">
                            ...
                            <div class="post-medium-block">
                                ...
                                <div class="content-block post-medium mb--20">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/blog-sm-01.jpg"
                                                alt="Post Images">
                                        </a>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="content-block post-medium mb--20">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/blog-sm-02.jpg"
                                                alt="Post Images">
                                        </a>
                                    </div>
                                    <div class="post-content">
                                ...
                                <div class="content-block post-medium">
                                    <div class="post-thumbnail">
                                        <a href="post-details.html">
                                            <img src="{{ asset('frontend') }}/assets/images/small-images/blog-sm-03.jpg"
                                                alt="Post Images">
                                        </a>
                                    </div>
                                    <div class="post-content">
                        ...
                        <div class="axil-single-widget widget widget_ads mb--30">
                            ...
                            <div class="thumbnail">
                                <a href="#">
                                    <img src="{{ asset('frontend') }}/assets/images/post-single/ads-01.jpg"
                                        alt="Ads Images">
                                </a>
                            </div>
                            <!-- End Post List  -->
                            ...
                            <div class="video-post-wrapepr">
                                ...
                                <div class="content-block image-rounded">
                                    <div class="post-content">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/post-single/post-md-01.jpg"
                                                    alt="Post Images">
                                            </a>
                                ...
                                <div class="content-block image-rounded mt--20">
                                    <div class="post-content">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/post-single/post-md-02.jpg"
                                                    alt="Post Images">
                                            </a>
                                            <a class="video-popup size-medium icon-color-secondary position-top-center"
                                                href="post-details.html"><span class="play-icon"></span></a>
                                        </div>
                                        <h6 class="title mt--10"><a href="post-details.html">A rocket launch can’t unite
                                                us until the space
                                ...
                                <div class="content-block image-rounded mt--20">
                                    <div class="post-content">
                                        <div class="post-thumbnail">
                                            <a href="post-details.html">
                                                <img src="{{ asset('frontend') }}/assets/images/post-single/post-md-03.jpg"
                                                    alt="Post Images">
                                            </a>
                                            <a class="video-popup size-medium icon-color-secondary position-top-center"
                                                href="post-details.html"><span class="play-icon"></span></a>
                                        </div>
                                        <h6 class="title mt--10"><a href="post-details.html"> With iOS 14, Apple is
                                                finally letting the
                        ...
                        <div class="axil-banner">
                            <div class="thumbnail">
                                <a href="#">
                                    <img class="w-100"
                                        src="{{ asset('frontend') }}/assets/images/add-banner/banner-02.png"
                                        alt="Banner Images">
                                </a>
                            </div>
                        </div>
